    ...
    return (
        <div className='container' id='about'>
            <div className='about'>
                ...
                <p>
                    Hi! I'm a Frontend Developer with over 6 years of experience building high-performance, user-focused web applications — primarily in the e-commerce space. I specialize in modern JavaScript frameworks like React, and I'm skilled in Redux, TypeScript, and Next.js for building scalable, maintainable frontends.
                </p>
                <p>
